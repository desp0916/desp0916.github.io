...
/*
     FILE ARCHIVED ON 19:08:36 四月 8, 2015 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 5:57:07 一月 18, 2016.
...
if (window.MSApp) {
    ...
    suggestionList["Download Internet Explorer 11"] = "/web/20150408190836/http://windows.microsoft.com/en-us/internet-explorer/download-ie";
    suggestionList["Internet Explorer Team Blog"] = "/web/20150408190836/http://blogs.msdn.com/b/ie";
    suggestionList["Internet Explorer Test Drive Site"] = "/web/20150408190836/http://ie.microsoft.com/testdrive";
...
var _om_gbls = {
	...
	logError : function(e,txt) {
		var sourceURL="/web/20150408190836/http://microsoftwindows.112.2o7.net/b/ss/mswindowsie9tderr/1/H.20.2--NS/0";
...
function recruit() {
	...
	if(console && console.log) {
		console.log(recruitMessages[Math.floor(Math.random()*recruitMessages.length)] + "\r\n /web/20150408190836/http://www.microsoft-careers.com/go/internet-explorer/340041/");
	}
}
